...
public abstract class CompositeTravelPlannerCaseStudy extends AbstractChangeTests {
	...
	public CompositeTravelPlannerCaseStudy() {
		this.PATH_REPOSITORY = "contextSelectionModels/compositeTravelPlanner/default.repository";
		this.PATH_RESOURCES = "contextSelectionModels/compositeTravelPlanner/default.resourceenvironment";
		this.PATH_ASSEMBLY = "contextSelectionModels/compositeTravelPlanner/default.system";
		this.PATH_ALLOCATION = "contextSelectionModels/compositeTravelPlanner/default.allocation";
	}
