...
public abstract class ContextAbstractChangeTestsListEfforts extends AbstractModelTest {

    public ContextAbstractChangeTestsListEfforts() {
        this.PATH_ATTACKER = "contextSelectionModels/simpleAttackmodels/PropagationUnitTests/My.attacker";
        this.PATH_ASSEMBLY = "contextSelectionModels/simpleAttackmodels/PropagationUnitTests/newAssembly.system";
        this.PATH_ALLOCATION = "contextSelectionModels/simpleAttackmodels/PropagationUnitTests/newAllocation.allocation";
        this.PATH_CONTEXT = "contextSelectionModels/simpleAttackmodels/SimpleModelTest/My.context";
        this.PATH_MODIFICATION = "contextSelectionModels/simpleAttackmodels/PropagationUnitTests/My.kamp4attackmodificationmarks";
        this.PATH_REPOSITORY = "contextSelectionModels/simpleAttackmodels/PropagationUnitTests/newRepository.repository";
        this.PATH_USAGE = "contextSelectionModels/simpleAttackmodels/PropagationUnitTests/newUsageModel.usagemodel";
        this.PATH_RESOURCES = "contextSelectionModels/simpleAttackmodels/PropagationUnitTests/newResourceEnvironment.resourceenvironment";
    }
