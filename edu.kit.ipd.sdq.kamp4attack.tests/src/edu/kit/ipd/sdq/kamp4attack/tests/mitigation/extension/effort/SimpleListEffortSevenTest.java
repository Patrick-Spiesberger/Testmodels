...
class SimpleListEffortSevenTest extends AbstractModelTest {

	public SimpleListEffortSevenTest() {
		this.PATH_ATTACKER = "contextSelectionModels/effortModels/simpleEffortModel/attacker/sevenAttribute.attacker";
