...
class VulnerableListEffortFiveTest extends AbstractModelTest {

	public VulnerableListEffortFiveTest() {
		this.PATH_ATTACKER = "contextSelectionModels/effortModels/vulnerableEffortModel/attacker/fiveAttribute.attacker";
		...
		this.PATH_MODIFICATION = "contextSelectionModels/effortModels/vulnerableEffortModel/modificationmarks/five.kamp4attackmodificationmarks";
	...
	@Test
	void testVulnerableCaseFiveAttribute() {
