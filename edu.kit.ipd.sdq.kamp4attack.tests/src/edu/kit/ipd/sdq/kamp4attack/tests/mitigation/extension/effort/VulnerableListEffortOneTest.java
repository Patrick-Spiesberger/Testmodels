...
class VulnerableListEffortOneTest extends AbstractModelTest {

	public VulnerableListEffortOneTest() {
		this.PATH_ATTACKER = "contextSelectionModels/effortModels/vulnerableEffortModel/attacker/oneAttribute.attacker";
		...
		this.PATH_MODIFICATION = "contextSelectionModels/effortModels/vulnerableEffortModel/modificationmarks/one.kamp4attackmodificationmarks";
	...
	@Test
	void testVulnerableCaseOneAttribute() {
