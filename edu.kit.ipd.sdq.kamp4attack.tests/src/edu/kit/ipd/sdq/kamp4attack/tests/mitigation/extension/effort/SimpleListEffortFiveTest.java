...
class SimpleListEffortFiveTest extends AbstractModelTest {

	public SimpleListEffortFiveTest() {
		this.PATH_ATTACKER = "contextSelectionModels/effortModels/simpleEffortModel/attacker/fiveAttribute.attacker";
		...
		this.PATH_MODIFICATION = "contextSelectionModels/effortModels/simpleEffortModel/modificationmarks/five.kamp4attackmodificationmarks";
