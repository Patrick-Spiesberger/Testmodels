...
class VulnerableListEffortTwentyFiveTest extends AbstractModelTest {

	public VulnerableListEffortTwentyFiveTest() {
		this.PATH_ATTACKER = "contextSelectionModels/effortModels/vulnerableEffortModel/attacker/twentyfiveAttribute.attacker";
		...
		this.PATH_MODIFICATION = "contextSelectionModels/effortModels/vulnerableEffortModel/modificationmarks/twentyfive.kamp4attackmodificationmarks";
