...
public class CompositeCredentialsPropagationTests extends CompositeTravelPlannerCaseStudy {
	...
	public CompositeCredentialsPropagationTests() {
		this.PATH_ATTACKER = "contextSelectionModels/compositeTravelPlanner/tests/03/test_model.attacker";
		this.PATH_CONTEXT = "contextSelectionModels/compositeTravelPlanner/tests/03/test_model.context";
		this.PATH_MODIFICATION = "contextSelectionModels/compositeTravelPlanner/tests/03/test_model.kamp4attackmodificationmarks";
	}
